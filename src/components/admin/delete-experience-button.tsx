...
export function DeleteExperienceButton({ experienceId, experienceRole }: { experienceId: string, experienceRole: string }) {
      ...
      <DialogContent className="sm:max-w-md bg-[#0b1120] border-[#1e293b] shadow-2xl p-6">
        <DialogHeader className="gap-3">
          ...
          <DialogDescription className="text-slate-400 text-base leading-relaxed pt-2">
            Are you sure you want to delete <strong className="text-rose-400 font-semibold">{experienceRole}</strong>? This action cannot be undone.
          </DialogDescription>
        </DialogHeader>
