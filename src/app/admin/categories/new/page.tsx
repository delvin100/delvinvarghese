  ...
  return (
    <div className="space-y-8 max-w-2xl mx-auto relative mt-10">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl sm:text-4xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-emerald-400">Add Category</h1>
          <p className="text-muted-foreground mt-2 text-sm sm:text-base">Create a new group for your skills.</p>
        </div>
